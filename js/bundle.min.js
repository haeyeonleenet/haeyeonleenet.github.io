...
`.replace(/id="photos" class="tab-pane.*?" style="display:.*?"/,`id="photos" class="tab-pane ${a==="photos"?"active":""}" style="display:${a==="photos"?"block":"none"};"`).replace(/id="video" class="tab-pane.*?" style="display:.*?"/,`id="video" class="tab-pane ${a==="video"?"active":""}" style="display:${a==="video"?"block":"none"};"`).replace(/href="\/media\/photos" class="tab-btn.*?"/,`href="/media/photos" class="tab-btn ${a==="photos"?"active":""}"`).replace(/href="\/media\/videos" class="tab-btn.*?"/,`href="/media/videos" class="tab-btn ${a==="video"?"active":""}"`),h=()=>"<p>No upcoming events.</p>",u=()=>`
    <section class="content-section fade-in">
        <h2>Contact</h2>
