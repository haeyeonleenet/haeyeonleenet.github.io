...
<p>Ms. Lee\u2019s operatic repertoire includes notable roles such as Constance in Dialogues des Carm\xE9lites and Lauretta in Gianni Schicchi at the Wilhelma Theater and HMDK Stuttgart in Germany. She also performed the role of Susanna in Le Nozze di Figaro at the Kim Young-Eui Hall at Ewha Womans University.</p>
<p>As a concert soloist, Ms. Lee has performed in major venues across Korea. Her recent engagements include performing as the soloist for H\xE4ndel\u2019s Dixit Dominus (2025) and Mendelssohn\u2019s St. Paul (2024) at the Aram Music Hall, Goyang Aram Nuri Arts Center. She also held a Return Recital at the Youngsan Art Hall in 2025 and a Lied Duo Concert at Samik Art Hall in 2021.</p>
<p>Ms. Lee holds a Master of Arts (M.A.) in Opera from the Staatliche Hochschule f\xFCr Musik und Darstellende Kunst Stuttgart (HMDK) in Germany, and a Certificate of Advanced Studies (C.A.S.) in Vocal Performance. She earned her Bachelor of Arts in Vocal Performance from Ewha Womans University in Seoul. Her artistic development was further enriched by a scholarship from the Bach-Archiv Leipzig and masterclasses with renowned artists such as Hye Kyung Hong, Olaf B\xE4r, and Inge Borkh.</p>
                    </div>
                </div>
        ...
        <div class="cv-section">
            ...
            <ul style="margin-bottom: 2rem; line-height: 1.6;">
                <li>Soloist, H\xE4ndel dixit dominus<br>Aram Music Hall, Goyang Aram Nuri Arts Center, Korea | 2025</li>
...
<li>Lied Duo Concert<br>Samik Art Hall, Seoul, Korea | 2021</li>
        ...
        <div class="cv-section">
            ...
            <ul style="margin-bottom: 2rem; line-height: 1.6;">
                <li>Constance \u2013 Dialogues des Carm\xE9lites<br>HMDK Stuttgart, Stuttgart, Germany | Dec 2017</li>
...
<li>Susanna \u2013 Le Nozze di Figaro<br>Kim Young-Eui Hall, Ewha Womans University, Seoul, Korea | May 2014</li>
        ...
        <div class="cv-section">
            ...
            <ul style="margin-bottom: 2rem; line-height: 1.6;">
                <li>Certificate of Advanced Studies (C.A.S.), Vocal Performance<br>Staatliche Hochschule f\xFCr Musik und Darstellende Kunst Stuttgart (HMDK), Germany<br>2018 \u2013 2019</li>
<li>Master of Arts (M.A.), Opera<br>Staatliche Hochschule f\xFCr Musik und Darstellende Kunst Stuttgart (HMDK), Germany<br>2016 \u2013 2018</li>
...
<li>Olaf B\xE4r, Baritone<br>Kirchheim an der Weinstra\xDFe, Germany | 2018</li>
        ...
        <div class="media-content">
            ...
            <div id="video" class="tab-pane " style="display:none;">
                <div class="video-grid">
                    ...
                    <div class="video-card">
                        <div class="video-wrapper">
                            <iframe width="200" height="113" src="https://www.youtube.com/embed/6u0H9qrfP0A?feature=oembed" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen title="&quot;Es lebt eine Vilja&quot;- L\xE9har: Die lustige Witwe, Act II  \uC18C\uD504\uB77C\uB178 \uC774\uD574\uC5F0"></iframe>
                        </div>
                        <div class="video-info">
                            <h3>"Es lebt eine Vilja"- L\xE9har: Die lustige Witwe, Act II  \uC18C\uD504\uB77C\uB178 \uC774\uD574\uC5F0</h3>
                    ...
                    <div class="video-card">
                        <div class="video-wrapper">
                            <iframe width="200" height="113" src="https://www.youtube.com/embed/vJlTr-NDHek?feature=oembed" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen title="Mein Herr Marquis \xABDie Fledermaus\xBB, Strauss- \uC18C\uD504\uB77C\uB178 \uC774\uD574\uC5F0"></iframe>
                        </div>
                        <div class="video-info">
                            <h3>Mein Herr Marquis \xABDie Fledermaus\xBB, Strauss- \uC18C\uD504\uB77C\uB178 \uC774\uD574\uC5F0</h3>
                            <p class="date">2025-09-26</p>
                            <p class="desc">Live Performance from Winter Gala</p>
                        </div>
                    </div>
                    ...
                    <div class="video-card">
                        <div class="video-wrapper">
                            <iframe width="200" height="113" src="https://www.youtube.com/embed/LqJ6VFAw41g?feature=oembed" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen title="[\uC18C\uD504\uB77C\uB178 \uC774\uD574\uC5F0] Airs chant\xE9s - F. Poulenc"></iframe>
                        </div>
                        <div class="video-info">
                            <h3>[\uC18C\uD504\uB77C\uB178 \uC774\uD574\uC5F0] Airs chant\xE9s - F. Poulenc</h3>
                            <p class="date">2025-03-28</p>
                            <p class="desc">Live Performance from Return Recital</p>
                        </div>
                    </div>
                    ...
                    <div class="video-card">
                        <div class="video-wrapper">
                            <iframe width="200" height="113" src="https://www.youtube.com/embed/FaVKKcvNE84?feature=oembed" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen title="[\uC18C\uD504\uB77C\uB178 \uC774\uD574\uC5F0] Ich will dir mein Herze schenken, Matth\xE4us-Passion, BWV 244, J.S. Bach"></iframe>
                        </div>
                        <div class="video-info">
                            <h3>[\uC18C\uD504\uB77C\uB178 \uC774\uD574\uC5F0] Ich will dir mein Herze schenken, Matth\xE4us-Passion, BWV 244, J.S. Bach</h3>
                            <p class="date">2025-03-28</p>
                            <p class="desc">Live Performance from Return Recital</p>
                        </div>
                    </div>
...
`.replace(/id="photos" class="tab-pane.*?" style="display:.*?"/,`id="photos" class="tab-pane ${a==="photos"?"active":""}" style="display:${a==="photos"?"block":"none"};"`).replace(/id="video" class="tab-pane.*?" style="display:.*?"/,`id="video" class="tab-pane ${a==="video"?"active":""}" style="display:${a==="video"?"block":"none"};"`).replace(/href="\/media\/photos" class="tab-btn.*?"/,`href="/media/photos" class="tab-btn ${a==="photos"?"active":""}"`).replace(/href="\/media\/videos" class="tab-btn.*?"/,`href="/media/videos" class="tab-btn ${a==="video"?"active":""}"`),h=()=>"<p>No upcoming events.</p>",p=()=>`
    <section class="content-section fade-in">
        <h2>Contact</h2>
...
`;var s=class{constructor(){this.routes={"/":c,"/about":d,"/media":m,"/schedule":h,"/contact":p},this.app=document.getElementById("app")}init(){let e=new URLSearchParams(window.location.search).get("p");e?(window.history.replaceState(null,null,e),this.handleRoute(e),this.updateActiveLink(e)):(this.handleRoute(window.location.pathname),this.updateActiveLink(window.location.pathname)),window.addEventListener("popstate",()=>{this.handleRoute(window.location.pathname),this.updateActiveLink(window.location.pathname)}),document.body.addEventListener("click",i=>{i.target.matches("[data-link]")&&(i.preventDefault(),this.navigateTo(i.target.href))})}navigateTo(t){window.history.pushState(null,null,t),this.handleRoute(window.location.pathname),this.updateActiveLink(window.location.pathname)}async handleRoute(t){let e=t.endsWith("/")&&t!=="/"?t.slice(0,-1):t;if(e==="/media"){this.navigateTo("/media/photos");return}let i,r=[];e==="/media/photos"?(i=this.routes["/media"],r=["photos"]):e==="/media/videos"?(i=this.routes["/media"],r=["video"]):i=this.routes[e]||this.routes["/"],!i&&!this.routes[e]&&(i=this.routes["/"]),this.app.innerHTML=i(...r),this.app.querySelectorAll(".tab-btn[data-tab]").forEach(v=>{v.addEventListener("click",l=>{let b=l.target.getAttribute("data-tab"),n=l.target.closest(".content-section");n.querySelectorAll(".tab-btn").forEach(o=>o.classList.remove("active")),l.target.classList.add("active"),n.querySelectorAll(".tab-pane").forEach(o=>{o.id===b?(o.style.display="block",o.classList.add("active")):(o.style.display="none",o.classList.remove("active"))})})});let u={"/":"Haeyeon Lee | Soprano","/about":"About | Haeyeon Lee","/media/photos":"Media (Photos) | Haeyeon Lee","/media/videos":"Media (Videos) | Haeyeon Lee","/schedule":"Schedule | Haeyeon Lee","/contact":"Contact | Haeyeon Lee"};document.title=u[e]||"Haeyeon Lee | Soprano",window.scrollTo(0,0)}updateActiveLink(t){let e=t.endsWith("/")&&t!=="/"?t.slice(0,-1):t;document.querySelectorAll(".site-nav a").forEach(i=>{let r=i.getAttribute("href");r===e||r==="/media"&&e.startsWith("/media/")?i.classList.add("active"):i.classList.remove("active")})}};document.addEventListener("DOMContentLoaded",()=>{document.getElementById("year").textContent=new Date().getFullYear(),new s().init();let t=document.querySelector(".mobile-nav-toggle"),e=document.querySelector(".site-nav");t&&e&&(t.addEventListener("click",()=>{e.classList.toggle("open")}),e.querySelectorAll("a").forEach(i=>{i.addEventListener("click",()=>{e.classList.remove("open")})}))});})();
